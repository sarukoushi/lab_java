    ...
    while(true){
      try {
        IO.println(
          ...
          "# (3) Wyszukaj studenta na podstawie:\n"+
          "#        imienia/nazwiska/wieku,daty urodzenia:\n"+
          "#-------------------------------\n"+
          "# (x) Close the app.\n"+
          "################################\n"
        );
          ...
          switch(Integer.parseInt(act)){
            case 1:
              s.addStudent(new Student(
                  ...
                  Integer.parseInt(IO.readln("Input day of birth: ")),
                  Integer.parseInt(IO.readln("Input month of birth: ")),
                  Integer.parseInt(IO.readln("Input year of birth: "))
                  )
              );
              break;
            case 2:
